...
// REACT TO DELETE BUTTON ON ORDER
//---FILTER THROUGH ORDER LIST PASSED TO IT
//---RETURN AN ORDERS LIST WITHOUT THE DELETED ORDER
//---PASS THE NEW LIST AND THE ID OF THE DELETED ORDER UP
